...
from utils import save_samples, get_fid


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Diffusion Model Inference')
    parser.add_argument('--ckpt', default = 'epoch_199.pth', type=str, help="Pretrained checkpoint")
    ...
    parser.add_argument('--ddim-timesteps', type=int, default=1000, help="Number of timesteps to sample for DDIM")
